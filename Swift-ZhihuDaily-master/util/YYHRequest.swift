...
class YYHRequest: NSObject, NSURLConnectionDataDelegate {
    ...
    func queryString() -> String {
        ...
        for (key, value) in parameters {
            let encodedKey: NSString = key.stringByAddingPercentEncodingWithAllowedCharacters(.URLHostAllowedCharacterSet())!
            let encodedValue: NSString = value.stringByAddingPercentEncodingWithAllowedCharacters(.URLHostAllowedCharacterSet())!
